...
namespace ImGui
{
	...
	IMGUI_API bool			ListBoxConfigArray(const char* label, int* currIndex, std::vector<std::string>& values, int alpha = 0, int height = 9);
	IMGUI_API void          EndChild(int alpha = 255, bool namep = true);
	...
	IMGUI_API void          SetScrollHere(float center_y_ratio = 0.5f, float y_offset = 0.f);                         // adjust scrolling amount to make current cursor position visible. center_y_ratio=0.0: top, 0.5: center, 1.0: bottom.
	...
	IMGUI_API void          PushStyleColor(ImGuiCol idx, ImColor col);
	...
	IMGUI_API bool          Button(const char* label, const ImVec2& size = ImVec2(0, 0), const char* keybind_format = "None");
	IMGUI_API bool          Button(const char* label, const char* unique_id, const ImVec2& size_arg = ImVec2(0, 0));
	IMGUI_API bool			SemiTab(const char* label, const ImVec2& size_arg = ImVec2(0, 0), bool active = false);
	IMGUI_API bool			SemiTabRage(const char* label, const ImVec2& size_arg = ImVec2(0, 0), bool active = false);
	IMGUI_API bool          Button(const char* label, const char* icon, ImFont * iconfont, float x_add = 0.4f, const ImVec2& size = ImVec2(0, 0));// button
	...
	IMGUI_API bool			Combo(const char* label, int* current_item, bool(*items_getter)(void*, int, const char**), void* data, int items_count, int height_in_items = 9);
	IMGUI_API bool          Combo(const char* label, int* current_item, const char* const* items, int items_count, int height_in_items = 9);
	IMGUI_API bool          Combo(const char* label, int* current_item, const char* items_separated_by_zeros, int height_in_items = 9);    // separate items with \0, end item-list with \0\0
	...
	IMGUI_API bool          DragFloat(const char* label, float* v, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char* display_format = "%.2f", float power = 1.0f);     // If v_min >= v_max we have no bound
	IMGUI_API bool          DragFloat2(const char* label, float v[2], float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char* display_format = "%.2f", float power = 1.0f);
	IMGUI_API bool          DragFloat3(const char* label, float v[3], float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char* display_format = "%.2f", float power = 1.0f);
	IMGUI_API bool          DragFloat4(const char* label, float v[4], float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char* display_format = "%.2f", float power = 1.0f);
	IMGUI_API bool          DragFloatRange2(const char* label, float* v_current_min, float* v_current_max, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char* display_format = "%.2f", const char* display_format_max = NULL, float power = 1.0f);
	...
	IMGUI_API bool          InputText(const char* label, char* buf, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiTextEditCallback callback = NULL, void* user_data = NULL, bool can_focus = true);
	...
	IMGUI_API bool          InputInt(const char* label, int* v, int step = 1, int step_fast = 100, ImGuiInputTextFlags extra_flags = 0, bool can_focus = true);
	...
	IMGUI_API bool          SliderFloat(const char* label, float* v, float v_min, float v_max, bool none_zero = false, bool minimum_damage = false, const char* display_format = "%.2f", float power = 1.0f);     // adjust display_format to decorate the value with a prefix or a suffix for in-slider labels or unit display. Use power!=1.0 for logarithmic sliders
	IMGUI_API bool          SliderFloat2(const char* label, float v[2], float v_min, float v_max, const char* display_format = "%.2f", float power = 1.0f);
	IMGUI_API bool          SliderFloat3(const char* label, float v[3], float v_min, float v_max, const char* display_format = "%.2f", float power = 1.0f);
	IMGUI_API bool          SliderFloat4(const char* label, float v[4], float v_min, float v_max, const char* display_format = "%.2f", float power = 1.0f);
	IMGUI_API bool          SliderAngle(const char* label, float* v_rad, float v_degrees_min = -360.0f, float v_degrees_max = +360.0f);
	IMGUI_API bool          SliderInt(const char* label, int* v, int v_min, int v_max, bool minimum_damage = false, const char* display_format = "%.0f");
	IMGUI_API bool          SliderInt2(const char* label, int v[2], int v_min, int v_max, const char* display_format = "%.0f");
	IMGUI_API bool          SliderInt3(const char* label, int v[3], int v_min, int v_max, const char* display_format = "%.0f");
	IMGUI_API bool          SliderInt4(const char* label, int v[4], int v_min, int v_max, const char* display_format = "%.0f");
	IMGUI_API bool          VSliderFloat(const char* label, const ImVec2& size, float* v, float v_min, float v_max, const char* display_format = "%.2f", float power = 1.0f);
	...
	IMGUI_API bool          ColorEdit4(const char* label, Color* newcolor, ImGuiColorEditFlags flags = 0);
	...
	IMGUI_API bool			SelectableMeme(const char * label, bool selected, ImGuiSelectableFlags flags, const ImVec2 & size_arg, int alpha = 255);
	IMGUI_API bool          Selectable(const char* label, bool selected = false, bool last = false, ImGuiSelectableFlags flags = 0, const ImVec2& size = ImVec2(0, 0));  // size.x==0.0: use remaining width, size.x>0.0: specify width. size.y==0.0: use label height, size.y>0.0: specify height
	IMGUI_API bool          Selectable(const char* label, bool* p_selected, bool last = false, ImGuiSelectableFlags flags = 0, const ImVec2& size = ImVec2(0, 0));
	IMGUI_API bool          ListBox(const char* label, int* current_item, const char* const* items, int items_count, int height_in_items = -1);
	IMGUI_API bool          ListBox(const char* label, int* current_item, bool(*items_getter)(void* data, int idx, const char** out_text), void* data, int items_count, int height_in_items = -1, int alpha = 0);
	IMGUI_API bool          ListBoxHeader(const char* label, const ImVec2& size = ImVec2(0, 0), int alpha = 0); // use if you want to reimplement ListBox() will custom data or interactions. make sure to call ListBoxFooter() afterwards.
	IMGUI_API bool          ListBoxHeader(const char* label, int items_count, int height_in_items = -1, int alpha = 0); // "
	...
	IMGUI_API void          EndChildFrame(bool namep = false);
...
public:
	...
	inline void                 reserve(int new_capacity)
	{
		...
		if (Data)
			memcpy(new_data, Data, (size_t)Size * sizeof(value_type)); //-V780
		ImGui::MemFree(Data);
		Data = new_data;
...
struct ImColor
{
	...
	ImColor(const ImVec4& col) { Value = col; } //-V818
...
struct ImDrawList
{
	...
	inline    void  PathLineToMergeDuplicate(const ImVec2& pos) { if (_Path.Size == 0 || memcmp(&_Path[_Path.Size - 1], &pos, 8) != 0) _Path.push_back(pos); } //-V1014
