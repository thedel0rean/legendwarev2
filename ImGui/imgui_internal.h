...
static inline int    ImLerp(int a, int b, float t) { return (int)(a + (b - a) * t); } //-V2003
...
static inline float  ImFloor(float f) { return (float)(int)f; } //-V2003
static inline ImVec2 ImFloor(const ImVec2& v) { return ImVec2((float)(int)v.x, (float)(int)v.y); } //-V2003
...
struct IMGUI_API ImRect
{
	...
	void        Floor() { Min.x = (float)(int)Min.x; Min.y = (float)(int)Min.y; Max.x = (float)(int)Max.x; Max.y = (float)(int)Max.y; } //-V2003
...
struct ImGuiPopupRef
{
	...
	ImGuiPopupRef(ImGuiID id, ImGuiWindow* parent_window, ImGuiID parent_menu_set, const ImVec2& mouse_pos) { PopupId = id; Window = NULL; ParentWindow = parent_window; ParentMenuSet = parent_menu_set; MousePosOnOpen = mouse_pos; } //-V818
};
...
namespace ImGui
{
	...
	IMGUI_API bool          ButtonEx(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0, const char* keybind_format = "None");
	IMGUI_API bool          ButtonEx(const char* label, const char* icon, ImFont * iconfont, float x_add = 0.4f, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
	...
	IMGUI_API bool          InputTextEx(const char* label, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiTextEditCallback callback = NULL, void* user_data = NULL, bool can_focus = true);
	IMGUI_API bool          InputFloatN(const char* label, float* v, int components, int decimal_precision, ImGuiInputTextFlags extra_flags);
	IMGUI_API bool          InputIntN(const char* label, int* v, int components, ImGuiInputTextFlags extra_flags);
	IMGUI_API bool          InputScalarEx(const char* label, ImGuiDataType data_type, void* data_ptr, void* step_ptr, void* step_fast_ptr, const char* scalar_format, ImGuiInputTextFlags extra_flags, bool can_focus = true);
