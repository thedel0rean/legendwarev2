...
namespace hooks
{
	...
	using UpdateClientSideAnimationFn = void(__fastcall*)(player_t*, uint32_t);
	...
	void __fastcall hooked_updateclientsideanimation(player_t* player, uint32_t);
	_declspec(noinline)void updateclientsideanimation_detour(player_t* player, uint32_t i);
